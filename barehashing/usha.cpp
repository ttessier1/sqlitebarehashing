...
extern "C" {
    ...
    int USHAReset(USHAContext* context, enum SHAversion whichSha)
    {
        ...
        switch (whichSha) {
        case VersionSHA1:   return SHA1Reset((SHA1Context*)&context->ctx);
        case VersionSHA224: return SHA224Reset((SHA224Context*)&context->ctx);
        case VersionSHA256: return SHA256Reset((SHA256Context*)&context->ctx);
        case VersionSHA384: return SHA384Reset((SHA384Context*)&context->ctx);
        case VersionSHA512: return SHA512Reset((SHA512Context*)&context->ctx);
    ...
    {
        switch (whichSha) {
        case VersionSHA1:   return SHA1_Message_Block_Size;
        case VersionSHA224: return SHA224_Message_Block_Size;
        case VersionSHA256: return SHA256_Message_Block_Size;
        case VersionSHA384: return SHA384_Message_Block_Size;
        default:
        case VersionSHA512: return SHA512_Message_Block_Size;
        }
    }
    ...
    {
        switch (whichSha) {
        case VersionSHA1:   return SHA1HashSize;
        case VersionSHA224: return SHA224HashSize;
        case VersionSHA256: return SHA256HashSize;
        case VersionSHA384: return SHA384HashSize;
        default:
        case VersionSHA512: return SHA512HashSize;
        }
    }
    ...
    {
        switch (whichSha) {
        case VersionSHA1:   return SHA1HashSizeBits;
        case VersionSHA224: return SHA224HashSizeBits;
        case VersionSHA256: return SHA256HashSizeBits;
        case VersionSHA384: return SHA384HashSizeBits;
        default:
        case VersionSHA512: return SHA512HashSizeBits;
        }
    }
    ...
    {
        switch (whichSha) {
        case VersionSHA1:   return "SHA1";
        case VersionSHA224: return "SHA224";
        case VersionSHA256: return "SHA256";
        case VersionSHA384: return "SHA384";
        default:
        case VersionSHA512: return "SHA512";
        }
    }
