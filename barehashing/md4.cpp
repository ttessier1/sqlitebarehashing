...
extern "C" {
    ...
    void MD4Update(MD4_CTX* context, unsigned char* input, unsigned int inputLen)
    {
        ...
        if (inputLen >= partLen)
        {
            MD4_memcpy((unsigned char*)&context->buffer[index], (unsigned char*)input, partLen);
        ...
        MD4_memcpy((unsigned char*)&context->buffer[index], (unsigned char*)&input[i],inputLen - i);
    }
